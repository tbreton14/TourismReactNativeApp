                ...
                <View style={{flex: 1, backgroundColor: "#f5f5f5", borderTop: '1px solid #d7d7d7'}}>
                    <View style={{flex: 1}}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('RestaurantsScreen')}
                            ...
                            <ImageBackground source={require("../../TourismReactNativeApp/assets/restaurants.jpg")} style={styles.homeImage}
                                             resizeMode='cover'/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{flex: 1}}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('HotelsScreen')} style={styles.homeButton}>
                            ...
                            <ImageBackground source={require("../../TourismReactNativeApp/assets/hotels.jpg")} style={styles.homeImage}
                                             resizeMode='cover'/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{flex: 1}}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('LoisirsScreen')}
                            ...
                            <ImageBackground source={require("../../TourismReactNativeApp/assets/loisirs.jpg")} style={styles.homeImage}
                                             resizeMode='cover'/>
                        </TouchableOpacity>
                    </View>
                </View>
